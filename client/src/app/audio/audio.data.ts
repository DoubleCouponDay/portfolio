...
export const musicvolume = 0.2
export const effectvolume = 0.8

export const gratingsoundaddress = 'assets/stone-grinding.flac'
export const drawbridgesoundaddress = 'assets/drawbridge.flac'
export const tabletsoundaddress = 'assets/tabletscraping.flac'
