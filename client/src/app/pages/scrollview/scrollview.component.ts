...
import { effectvolume, tabletsoundaddress } from 'src/app/audio/audio.data';
...
export class ScrollviewComponent implements OnDestroy, AfterViewInit {
  ...
  private scrapesoundgenerator = new generatedraggableaudio(tabletsoundaddress, effectvolume)
